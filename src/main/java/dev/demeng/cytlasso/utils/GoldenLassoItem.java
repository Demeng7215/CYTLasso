...
public final class GoldenLassoItem {
  ...
  public static Recipe getRecipe() {
    ...
    final String[] matrix =
        CYTLasso.getInstance().getSettings().getString("recipe.matrix.form").split(";");
    ...
    if (matrix.length != 3
      ...
      MessageUtils.console(
          "&4ERROR: &cAll 3 rows in the crafting recipe matrix must have "
    ...
    for (String key :
        CYTLasso.getInstance()
            .getSettings()
            .getConfigurationSection("recipe.matrix.definitions")
            .getKeys(false)) {
      ...
      recipe.setIngredient(
          ...
          XMaterial.valueOf(
                  CYTLasso.getInstance()
                      .getSettings()
                      .getString("recipe.matrix.definitions." + key))
              .parseMaterial());
    }
  ...
  public static ItemStack getGoldenLasso() {
    ...
    meta.setDisplayName(
        MessageUtils.colorize(CYTLasso.getInstance().getSettings().getString("item.display-name")));
    meta.setLore(lore);
